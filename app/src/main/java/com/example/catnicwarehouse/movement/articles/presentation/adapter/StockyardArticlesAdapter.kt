...
class StockyardArticlesAdapter(
    ...
    ListAdapter<WarehouseStockyardInventoryResponseModel, StockyardArticlesAdapter.ViewHolder>(
        DiffCallback()
    ) {
    ...
    class ViewHolder(
        ...
        fun bind(item: WarehouseStockyardInventoryResponseModel) {
            binding.apply {
                ...
                val articleAmount = "${item.amount}/${item.unit}"
    ...
    private class DiffCallback : DiffUtil.ItemCallback<WarehouseStockyardInventoryResponseModel>() {
        override fun areItemsTheSame(
            oldItem: WarehouseStockyardInventoryResponseModel,
            newItem: WarehouseStockyardInventoryResponseModel
        ): Boolean =
...
interface WarehouseStockyardArticleAdapterInteraction {
    fun onViewClicked(data: WarehouseStockyardInventoryResponseModel)
}