package com.example.catnicwarehouse.incoming.matchFound.presentation.viewModel
...
class MatchFoundViewModel @Inject constructor(
    ...
    private fun createDeliveryItem(
        deliveryId: String,
    ...
    fun onEvent(event: MatchFoundEvent) {
        when (event) {
            is MatchFoundEvent.CreateDeliveryItem -> createDeliveryItem(
                event.deliveryId,
