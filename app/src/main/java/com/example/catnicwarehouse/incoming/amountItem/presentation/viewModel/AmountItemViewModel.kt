package com.example.catnicwarehouse.incoming.amountItem.presentation.viewModel
...
@HiltViewModel
class AmountItemViewModel @Inject constructor(
    private val getArticleUnitsUseCase: GetArticleUnitsUseCase
) : BaseViewModel() {


    private val _amountItemFlow = MutableStateFlow<AmountItemViewState>(AmountItemViewState.Empty)
