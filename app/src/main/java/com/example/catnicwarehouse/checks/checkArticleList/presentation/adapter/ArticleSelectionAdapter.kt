package com.example.catnicwarehouse.checks.checkArticleList.presentation.adapter
...
class ArticleSelectionAdapter(
    ...
    private val checksSharedViewModel: ChecksSharedViewModel,
    private val isForArticlesList:Boolean
) :
...
//                subtitle1.text = item.articleId
                ...
                if(isForArticlesList){
                    title.text = item.stockYardName
